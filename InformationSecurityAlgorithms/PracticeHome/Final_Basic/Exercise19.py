...
Câu 19. Viết chương trình in ra các số nguyên dương x
 nằm trong khoảng [m,l] sao cho giá trị của biểu thức 𝐴𝑥^2 + 𝐵𝑥 + 𝐶
 là một số nguyên tố. Với A,B,C, m,l là các
...
def expression_prime(number_a, number_b,  # giá trị biểu thức
                     number_c, m, l):
    r = []
